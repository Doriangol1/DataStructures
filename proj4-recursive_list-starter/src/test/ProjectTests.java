...
public class ProjectTests {
	...
	public void testInsertsAts() {
		...
		list.insertAtEnd("E");
		assertEquals("Checking position 0.", "B", list.getAt(0));
		assertEquals("Checking position 1.", "E", list.getAt(1));
		list.insertAt(1, "D");
		assertEquals("Checking position 0.", "B", list.getAt(0));
		assertEquals("Checking position 1.", "E", list.getAt(2));
		assertEquals("Checking position 2.", "D", list.getAt(1));
		list.insertAt(1, "C");
		assertEquals("Checking position 0.", "B", list.getAt(0));
		assertEquals("Checking position 1.", "E", list.getAt(3));
		assertEquals("Checking position 2.", "C", list.getAt(1));
		assertEquals("Checking position 3.", "D", list.getAt(2));
		list.insertAtEnd("G");
		assertEquals("Checking position 0.", "B", list.getAt(0));
		assertEquals("Checking position 2.", "C", list.getAt(1));
		assertEquals("Checking position 3.", "D", list.getAt(2));
		assertEquals("Checking position 1.", "E", list.getAt(3));
		assertEquals("Checking position 3.", "G", list.getAt(4));
		list.insertAtBeginning("A");
		assertEquals("Checking position 0.", "B", list.getAt(1));
		assertEquals("Checking position 2.", "C", list.getAt(2));
		assertEquals("Checking position 3.", "D", list.getAt(3));
		assertEquals("Checking position 1.", "E", list.getAt(4));
		assertEquals("Checking position 3.", "G", list.getAt(5));
		assertEquals("Checking position 3.", "A", list.getAt(0));
		list.insertAt(5, "F");
	...
	@Test
	public void testCostume() {
		assertTrue("Newly constructed list should be empty.", list.isEmpty());
		list.insertAtEnd("Hello");
		assertEquals("Checking position 0.", 0, list.indexOf("Hello"));
		list.insertAtEnd("World");
		assertEquals("Checking position 0.", 0, list.indexOf("Hello"));
		//list.removeAt(1);

		assertTrue("", list.size() == 2);
		//assertEquals("Checking position 1.",  0, list.indexOf("Hello"));
		assertEquals("Checking position 2.", 1, list.indexOf("World"));
		//assertEquals("Checking position 3.", "E", list.getAt(3));
	}
	@Test
	public void test2() {
		...
		assertEquals("Checking position 1.", 0, list.indexOf("Hello"));
		assertEquals("Size should be 3", 3, list.size());
		assertEquals("0th element should .equals \"Hello\"", 1, list.indexOf("There"));
		assertEquals("Last element should .equals \"World!\"", 2, list.indexOf("World!"));
		list.removeLast();
		assertEquals("Size should be 3", 2, list.size());
		assertEquals("Checking position 1.", 0, list.indexOf("Hello"));
		assertEquals("0th element should .equals \"Hello\"", 1, list.indexOf("There"));
		list.removeLast();
		assertEquals("Size should be 3", 1, list.size());
		assertEquals("0th element should .equals \"Hello\"", 0, list.indexOf("Hello"));
		list.removeLast();
		assertEquals("Size should be 3", 0, list.size());
	}
}
