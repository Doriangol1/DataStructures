...
public class FizzBuzzTest {
	...
	public void testNotFizzOrBuzzTrivial() {
		...
		//ToDo 1 - write an assert statement that sends the number 2 as a parameter to the constructor of the ThreeFour instance. The expected answer is "2".
		//ANSWER
		assertEquals("2", ThreeFour.getValue(2));
	...
	public void testFizzOrBuzzTrivial() {
		...
		/*
		ToDo 2 - write an assert statement that sends the number 4 as parameter to the constructor of the ThreeFour instance. The expected answer is "buzz".
		*/
		//ANSWER
		assertEquals("buzz", ThreeFour.getValue(4));
			
	}
	
	@Test
	public void testNotFizzOrBuzz_1() {
	...
	@Test
	public void testNotFizzOrBuzz_2() {
		assertEquals("getValue returns incorrect value", "59",
				ThreeFour.getValue(59));
		assertEquals("getValue returns incorrect value", "3",
				TwoFive.getValue(3));
	...
	/*
	ToDo 3 - Write a test called "testGetValuesOffset".
	The test String array contains "2", "fizz", "buzz", "5", "fizz". The test checks the array that is returned with ThreeFour.getValues(2, 6)).
	...
	*/
	...
	public void testGetValuesOffset(){
			assertEquals(new String[] {"2", "fizz", "buzz", "5", "fizz"}, ThreeFour.getValues(2,6));
